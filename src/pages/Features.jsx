  ...
  return (
    <div id="features" className="relative h-screen md:flex text-white overflow-hidden pt-10 md:pt-0">
      ...
      <AnimatePresence
        ...
        onEnterStart={handleAnimationStart}
      >
        <div className="relative h-1/2 md:h-full md:w-1/2 mb-[10%] lg:mb-[0%] pb-0 md:pb-[20%] lg:pb-0  px-8 md:px-14 lg:px-48 z-20 text-white space-y-6 md:space-y-12 flex flex-col justify-center z-10">
          <motion.div
            key={options[index]}
      ...
      {/* MENU */}
      <div className="mt-[0%] md:mt-[20%] lg:mt-[0%] md:w-1/2 px-8 md:px-0 flex justify-center items-center z-20">
